...
class GigService {
  ...
  async getSellerGigs(sellerId: string): Promise<AxiosResponse> {
    const response: AxiosResponse = await axiosGigInstance.get(
      `/seller/${sellerId}`,
    );
    return response;
  }
  ...
  async createGig(body: SellerGig): Promise<AxiosResponse> {
    const response: AxiosResponse = await axiosGigInstance.post(
      '/create',
      body,
    );
    return response;
  ...
  async updateGig(gigId: string, body: SellerGig): Promise<AxiosResponse> {
    const response: AxiosResponse = await axiosGigInstance.put(
      `/${gigId}`,
      body,
    );
    return response;
  ...
  async deleteGig(gigId: string, sellerId: string): Promise<AxiosResponse> {
    const response: AxiosResponse = await axiosGigInstance.delete(
      `/${gigId}/${sellerId}`,
    );
    return response;
  }
